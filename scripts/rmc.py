...
def compile_single_rust_file(input_filename, output_filename, verbose=False, debug=False, keep_temps=False, mangler="v0", dry_run=False, abs_type="std", symbol_table_passes=[]):
    if not keep_temps:
