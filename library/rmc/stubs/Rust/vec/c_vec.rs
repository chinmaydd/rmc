...
// how do we handle typesafety here ?
// And must be identical to the definition in the .h file
...
impl Vec {
    ...
    pub fn new() -> Self {
        unsafe { Vec { ptr: vec_new() } }
    }

    pub fn with_capacity(cap: usize) -> Self {
        unsafe { Vec { ptr: vec_with_capacity(cap) } }
    }
